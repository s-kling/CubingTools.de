...
To reduce abuse, we use an email confirmation step. Your message is stored and processed to send confirmation emails and, once confirmed, to deliver your message to the site operator.
...
- Secure storage of logs, cookie data, and contact form data.
