...
When you use WCA-related features, we request public WCA data through a third-party API mirror hosted on GitHub. When you use the contact form, confirmation and notification emails are sent through our configured email service provider.
